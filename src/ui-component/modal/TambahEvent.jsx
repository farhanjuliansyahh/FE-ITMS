...
function AddEventModal({ open, handleClose, onEventAdded }) {
        ...
        >
          <div>
            ...
            <Autocomplete
              ...
              style={{ width: 500 }}
              renderInput={(params) => <TextField {...params} label="Job Level" placeholder="Job Level" />}
            />

            <TextField select required id="outlined-required" label="Job Family" onChange={handleJobFamilyChange}>
              {jobFamilyOptions.map((jobFamily) => (
                <MenuItem value={jobFamily.kode_rumpun_jabatan}>{jobFamily.nama_rumpun_jabatan}</MenuItem>
              ))}
            </TextField>
            ...
            <Autocomplete
              ...
              renderInput={(params) => <TextField {...params} label="Committee" variant="outlined" />}
            />
