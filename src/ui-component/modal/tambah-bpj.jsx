...
function TambahBPJ({ open, handleClose }) {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>
        <Typography style={{ fontSize: '24px', fontWeight: '700', textAlign: 'center', marginTop: '10px' }}>Tambah Anggota BPJ</Typography>
      </DialogTitle>
      <DividerContainer>
      ...
      <DialogContent>
        <Box>
          <TextField select required id="nippos-bpj" label="NIPPOS BPJ" sx={{ width: '100%', marginBottom: '16px' }}>
