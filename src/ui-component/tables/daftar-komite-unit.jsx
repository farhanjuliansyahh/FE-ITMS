...
const rows = [
  ...
  createData(4, 'Niken Wijaya', '998494379', 'Asisten Manajer Penjualan dan Kemitraan Pospay', 'Kantor Pusat Bandung'),
  createData(5, 'Niken Wijaya', '998494379', 'Asisten Manajer Pengelolaan Administrasi dan Kinerja Bidding', 'Kantor Pusat Bandung'),
];

export default function TabelDaftarAnggotaKomiteUnit({ onOpenSecondModalTable }) {
  ...
  return (
    <div>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={() => handleItemClick(2)}>5</MenuItem>
        <MenuItem onClick={() => handleItemClick(5)}>10</MenuItem>
        <MenuItem onClick={() => handleItemClick(10)}>50</MenuItem>
      </Menu>
    </div>
  );
}
