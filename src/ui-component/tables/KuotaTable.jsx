...
export default function KuotaTable({
  header,
  initialValue,
  bobot,
  refetchstate,
              ...
              <TableRow key={index}>
                ...
                <StyledTableCell align="right">
                  <Stack direction="column" alignItems="flex-end">
                    <IconButton onClick={() => handleIncrease(index, 'kuota')} sx={{ padding: '0', marginBottom: '1px' }}>
                      <ExpandLess sx={{ fontSize: '16px' }} />
                    </IconButton>
                    <IconButton onClick={() => handleDecrease(index, 'kuota')} sx={{ padding: '0', marginTop: '1px' }}>
