...
const TalentQualification = ({ eventid, kodekomite, prevLocation, nama_event }) => {
  ...
  const handleDownloadCSV = () => {
    ...
    const includedData = ['No', 'Nama', 'Nippos', 'Posisi', 'Job Level', 'Rumpun Jabatan', 'Nama Kantor', 'Komite Unit', 'Competency/Psychotest', 'PMS', 'AKHLAK', 'Learning Agility'];
  
    // Create a CSV header with the included column names
    const headerNames = ['No', 'Nama', 'NIPPOS', 'Posisi', 'Job Level', 'Rumpun Jabatan', 'Kantor', 'Komite Unit', 'Competency/Psychotest', 'PMS', 'AKHLAK', 'Learning Agility'];
        ...
        <CustomTabPanel value={value} index={0}>
          <Box paddingLeft={3} paddingRight={3} paddingBottom={3}>
            ...
            <TalentQualificationTable
              ...
              initialDataLength={quallolosRow.length}
            />
          </Box>
        </CustomTabPanel>
        ...
        <CustomTabPanel value={value} index={1}>
          <Box paddingLeft={3} paddingRight={3} paddingBottom={3}>
            ...
            <TalentQualificationTable
              ...
              initialDataLength={qualRow.length}
            />
          </Box>
        </CustomTabPanel>
      </MainCard>
