...
const DaftarEventKomiteUnit = () => {
  ...
  const filteredEventsTab0 = filteredEvents.filter((event) => event.statusisi === false && event.evenstatus_id === 2);
  ...
  const filteredEventsTab1 = filteredEvents.filter((event) => event.statusisi === true || event.evenstatus_id !== 2);
